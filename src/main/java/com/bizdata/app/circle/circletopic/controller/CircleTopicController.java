...
//        binder.registerCustomEditor(String.class, new StringEditor());
    ...
    public ModelAndView editView(String id) {
        ...
        //编辑时转义
        circleTopic = StringUnescapeHtml.unescapeHtml(circleTopic,"content");
        mv.addObject("topic", circleTopic);
        mv.setViewName("app_page/circle/theme/edit");
        return mv;
    }
