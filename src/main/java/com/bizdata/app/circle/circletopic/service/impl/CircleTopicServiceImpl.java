...
public class CircleTopicServiceImpl implements CircleTopicService {
    ...
    public boolean save(CircleTopic circleTopic) {
        boolean state;
        try {
        	circleTopic = KindeditorIgnoreHtml.unescapeHtml(circleTopic, "content");
	...
	@Override
	public String getIdBytopicid(int id) {
		return circleTopicRepository.getIdBytopicid(id);
	}

	@Override
	public void setStateByClassId(String classid, String state) {
		circleTopicRepository.setStateByClassId(classid,state);
	}

	@Override
	public void setStateByCircleId(String circleid, String state) {
		circleTopicRepository.setStateByCircleId(circleid,state);
	}
