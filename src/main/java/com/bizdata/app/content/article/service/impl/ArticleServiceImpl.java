...
public class ArticleServiceImpl implements ArticleService {
	...
	public boolean save(Article ArticleClass) {
		boolean state;
		try {
			ArticleClass = KindeditorIgnoreHtml.unescapeHtml(ArticleClass, "article_content");
	...
	@Override
	public String getIdByArticleid(int s) {
		return ArticleClassRepository.getIdByArticleid(s);
	}

	@Override
	public void setState(String columnartid,String state) {
		ArticleClassRepository.setState(columnartid,state);
	}
