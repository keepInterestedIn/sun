...
public class PaoMaMapPersonServiceImpl implements PaoMaMapPersonService {
	...
	@Override
	public List<String> getJpushid(String n) {
		return paoMaMapPersonRepository.getJpushid(n);
	}

	@Override
	public Integer getRankByActivityIdAndUserId(String activityId, String userId) {
		return paoMaMapPersonRepository.getRankByActivityAndUserId(activityId, userId);
	}
