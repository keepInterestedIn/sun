package com.bizdata.app.feedback.controller;
...
public class FeedbackController {
	...
	@Autowired
	public FeedbackController(JqGridPageVO2JpaPageParamVO jqGridPageVO2JpaPageParamVO,
			JqGridSortVO2JpaSortParamVO jqGridSortVO2JpaSortParamVO, FeedbackService feedbackService) {
	...
	public ModelAndView view() {
		return new ModelAndView("app_page/feedback/list");
	}
	...
	public JpaPageResultVO list(JqGridPageVO jqGridPageVO, JqGridSortVO jqGridSortVO,
		...
		Page<Feedback> feedback = feedbackService.findAllByPage(jpaPageParamVO, jpaSortParamVO,
				searchfeedbackVO);
		for(Feedback fd:feedback){
			fd.setAccountnum(MagUserService.getAccountnumById(fd.getUserid()));
		}
		return new JpaPageResultVO<>(feedback, Feedback.class);
	}
}
