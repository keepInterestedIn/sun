...
public class InformLocationController {
	...
	public ModelAndView addView() {
		Integer informid = informLocationService.getMaxid();
		informid = informid == null?0:informid;
		return new ModelAndView("app_page/informlocation/add","informid",informid+1);
	}
	...
	public ModelAndView editView(String id) {
		...
		//编辑时转义
		informLocation = StringUnescapeHtml.unescapeHtml(informLocation);
