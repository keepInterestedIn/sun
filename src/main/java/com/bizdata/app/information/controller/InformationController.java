...
public class InformationController {
	...
	public ModelAndView editView(String id) {
		...
		Information information = informationService.findOne(id);
		//编辑时转义
		information = StringUnescapeHtml.unescapeHtml(information,"informationcontent");
