...
public class KindEditorController {
	    ...
	    public Map<String, Object> fileUpload(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException,
	    	...
	    	//**********
	        //文件保存位置
	        String savePath = fileUploadConfig.getFilePath();
//	        String savePath = "F:/";//本地测试
	        //System.out.println("--------------"+savePath);
	        // 文件保存目录URL
	        String saveUrl = fileUploadConfig.getServerPrefix();
//	        String saveUrl = "F:/";//本地测试
	    ...
	    public void fileManager(HttpServletRequest request,
	        ...
	        String rootPath = fileUploadConfig.getFilePath();
//	        String rootPath = "F:/";//本地测试
	        //System.out.println("--------------"+savePath);
	        // 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
	        String rootUrl = fileUploadConfig.getServerPrefix();
//	        String rootUrl = "F:/";//本地测试
